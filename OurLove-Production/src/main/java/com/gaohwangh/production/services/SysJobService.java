...
import com.gaohwangh.production.scheduled.JobFactory;
import com.gaohwangh.production.scheduled.JobFactoryConcurrent;
...
public class SysJobService   {
    ...
    public void delete(HttpServletRequest request) throws Exception {
        ...
        if (StringUtils.isNotBlank(ids)) {
            ...
            try {
                ...
                SysJobDao mapper = sqlSession.getMapper(SysJobDao.class);
    ...
    public void sysJobCheckName(HttpServletRequest request) throws Exception {
        ...
        Integer integer = sysJobMapper.selectCount(model);
        if (integer > 0) {
